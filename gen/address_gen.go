...
//go:generate go run github.com/iotaledger/hive.go/codegen/features/cmd@13da292 address.tmpl ../address_anchor.gen.go AnchorAddress addr "chainid" "IdentifierType=AnchorID,AddressType=AddressAnchor,Description=is the Blake2b-256 hash of the OutputID which created it"
