...
bool mam_channel_t_set_find(mam_channel_t_set_t const *const set,
        mam_channel_t const *const value, mam_channel_t_set_entry_t const ** entry){
if (*set == NULL) {
return false;
}
...
bool mam_channel_t_set_cmp(mam_channel_t_set_t const *const lhs,
                          mam_channel_t_set_t const *const rhs){
