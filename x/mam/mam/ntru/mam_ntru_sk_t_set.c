...
bool mam_ntru_sk_t_set_find(mam_ntru_sk_t_set_t const *const set,
        mam_ntru_sk_t const *const value, mam_ntru_sk_t_set_entry_t const ** entry){
if (*set == NULL) {
return false;
}
...
bool mam_ntru_sk_t_set_cmp(mam_ntru_sk_t_set_t const *const lhs,
                          mam_ntru_sk_t_set_t const *const rhs){
