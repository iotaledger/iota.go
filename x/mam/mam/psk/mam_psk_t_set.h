...
typedef retcode_t (*mam_psk_t_on_container_func)(void *container,
                                                mam_psk_t *type);
...
bool mam_psk_t_set_find(mam_psk_t_set_t const *const set,
        mam_psk_t const *const , mam_psk_t_set_entry_t const ** entry);
...
bool mam_psk_t_set_cmp(mam_psk_t_set_t const * const lhs, mam_psk_t_set_t const * const rhs);
