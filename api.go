...
type ProtocolParameters struct {
	...
	// ManaGenerationRateShiftFactor is the amount of bits used to scale ManaGenerationRate.
	ManaGenerationRateShiftFactor uint8 //`serix:"10,mapKey=manaGenerationRateShiftFactor"`
	...
	// ManaDecayFactorsShiftFactor is the amount of bits used to scale ManaDecayFactors.
	ManaDecayFactorsShiftFactor uint8 //`serix:"12,mapKey=manaDecayFactorsShiftFactor"`
	...
	// ManaDecayFactorEpochsSumShiftFactor is the amount of bits used to scale ManaDecayFactorEpochsSum.
	ManaDecayFactorEpochsSumShiftFactor uint8 //`serix:"14,mapKey=manaDecayFactorEpochsSumShiftFactor"`
	...
	OrphanageThreshold SlotIndex `serix:"17,mapKey=orphanageThreshold"`
}
...
func (p ProtocolParameters) ManaDecayProvider() *ManaDecayProvider {
	// TODO: instead of EpochDurationInSlots, store the amount of bits in the protocol parameter and add a function for EpochDurationInSlots
	return NewManaDecayProvider(p.TimeProvider(), 13, p.ManaGenerationRate, p.ManaGenerationRateShiftFactor, p.ManaDecayFactors, p.ManaDecayFactorsShiftFactor, p.ManaDecayFactorEpochsSum, p.ManaDecayFactorEpochsSumShiftFactor)
}
