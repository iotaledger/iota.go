...
type basicProtocolParameters struct {
	...
	LivenessThreshold SlotIndex `serix:"12,mapKey=livenessThreshold"`
	...
	EpochNearingThreshold SlotIndex `serix:"15,mapKey=epochNearingThreshold"`
	// RMCParameters defines the parameters used by to calculate the Reference Mana Cost (RMC).
	CongestionControlParameters CongestionControlParameters `serix:"16,mapKey=congestionControlParameters"`

	VersionSignaling VersionSignaling `serix:"17,mapKey=versionSignaling"`
}
