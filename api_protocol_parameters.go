...
func (b basicProtocolParameters) Equals(other basicProtocolParameters) bool {
	return b.Version == other.Version &&
		...
		b.ManaBitsExponent == other.ManaBitsExponent &&
