...
func (b *TransactionBuilder) BuildAndSwapToBlockBuilder(signer iotago.AddressSigner, txFunc TransactionFunc) *BlockBuilder {
	blockBuilder := NewBlockBuilder(b.api)
