...
func TestTransactionBuilder(t *testing.T) {
	...
	tests := []test{
		func() test {
			inputUTXO1 := &iotago.UTXOInput{TransactionID: tpkg.Rand40ByteArray(), TransactionOutputIndex: 0}
		...
		func() test {
			var (
				inputID1 = &iotago.UTXOInput{TransactionID: tpkg.Rand40ByteArray(), TransactionOutputIndex: 0}
				inputID2 = &iotago.UTXOInput{TransactionID: tpkg.Rand40ByteArray(), TransactionOutputIndex: 1}
				inputID3 = &iotago.UTXOInput{TransactionID: tpkg.Rand40ByteArray(), TransactionOutputIndex: 4}
				inputID4 = &iotago.UTXOInput{TransactionID: tpkg.Rand40ByteArray(), TransactionOutputIndex: 8}
			)
