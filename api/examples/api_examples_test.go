...
// i req: seed, The seed from which to compute the addresses of.
...
// o: transaction.Transactions, The Transactions of the given hashes.
// o: error, Returned for invalid parameters and internal errors.
func ExampleGetTransactionObjects() {}

// i req: query, The object defining the transactions to search for.
// o: transaction.Transactions, The Transactions of the query result.
// o: error, Returned for invalid parameters and internal errors.
