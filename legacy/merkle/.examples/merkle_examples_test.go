...
func ExampleSignatureFragments() {
	...
	fragments, err := merkle.SignatureFragments(seed, 0, legacy.SecurityLevelMedium, "VAJOHANFEOTRSIPCLG9MIPENDFPLQQUGSBLBHMKZ9XVCUSWIKJOOHSPWJAXVLPTAKMPURYAYD9ONODVOW")
	if err != nil {
		// handle error
		return
	}
