...
func TestClient_BlockMetadataByBlockID(t *testing.T) {
	defer gock.Off()
...
func TestClient_BlockWithMetadataByBlockID(t *testing.T) {
	defer gock.Off()
	...
	nodeAPI := nodeClient(t)
	resp, err := nodeAPI.BlockWithMetadataByBlockID(context.Background(), blockID)
	require.NoError(t, err)
...
func TestClient_TransactionIncludedBlockMetadata(t *testing.T) {
	defer gock.Off()
	...
	mockGetJSON(api.EndpointWithNamedParameterValue(api.CoreRouteTransactionsIncludedBlockMetadata, api.ParameterTransactionID, txID.ToHex()), 200, originRes)

	nodeAPI := nodeClient(t)
	meta, err := nodeAPI.TransactionIncludedBlockMetadata(context.Background(), txID)
	require.NoError(t, err)
	require.EqualValues(t, originRes, meta)
}

func TestClient_TransactionMetadata(t *testing.T) {
	defer gock.Off()
...
func TestClient_CommitmentBySlot(t *testing.T) {
	...
	nodeAPI := nodeClient(t)
	resp, err := nodeAPI.CommitmentBySlot(context.Background(), slot)
	require.NoError(t, err)
	require.EqualValues(t, originRes, resp)
}
...
func TestClient_CommitmentUTXOChangesBySlot(t *testing.T) {
	...
	nodeAPI := nodeClient(t)
	resp, err := nodeAPI.CommitmentUTXOChangesBySlot(context.Background(), slot)
	require.NoError(t, err)
	require.EqualValues(t, originRes, resp)
}
...
func TestClient_CommitmentUTXOChangesFullBySlot(t *testing.T) {
	...
	nodeAPI := nodeClient(t)
	resp, err := nodeAPI.CommitmentUTXOChangesFullBySlot(context.Background(), slot)
	require.NoError(t, err)
	require.EqualValues(t, originRes, resp)
}
...
func TestClient_Validator(t *testing.T) {
	...
	res, err := nodeAPI.Validator(context.Background(), accountAddress)
	require.NoError(t, err)
	require.EqualValues(t, originRes, res)
}
