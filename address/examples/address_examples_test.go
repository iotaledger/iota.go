...
// i req: address, The address from which to compute the checksum of.
...
// i req: seed, The seed used for address generation.
// i req: start, The index from which to start to generate addresses from.
