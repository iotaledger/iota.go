...
var (
	ErrUnknown = errors.New("_cl: unknown error") // Generally an unexpected result from an OpenCL function (e.g. CL_SUCCESS but null pointer)
)

type ErrOther int

func (e ErrOther) Error() string {
	return fmt.Sprintf("_cl: error %d", int(e))
}

var (
	ErrDeviceNotFound                     = errors.New("_cl: Device Not Found")
	ErrDeviceNotAvailable                 = errors.New("_cl: Device Not Available")
	ErrCompilerNotAvailable               = errors.New("_cl: Compiler Not Available")
	ErrMemObjectAllocationFailure         = errors.New("_cl: Mem Object Allocation Failure")
	ErrOutOfResources                     = errors.New("_cl: Out Of Resources")
	ErrOutOfHostMemory                    = errors.New("_cl: Out Of Host Memory")
	ErrProfilingInfoNotAvailable          = errors.New("_cl: Profiling Info Not Available")
	ErrMemCopyOverlap                     = errors.New("_cl: Mem Copy Overlap")
	ErrImageFormatMismatch                = errors.New("_cl: Image Format Mismatch")
	ErrImageFormatNotSupported            = errors.New("_cl: Image Format Not Supported")
	ErrBuildProgramFailure                = errors.New("_cl: Build Program Failure")
	ErrMapFailure                         = errors.New("_cl: Map Failure")
	ErrMisalignedSubBufferOffset          = errors.New("_cl: Misaligned Sub Buffer Offset")
	ErrExecStatusErrorForEventsInWaitList = errors.New("_cl: Exec Status Error For Events In Wait List")
	ErrCompileProgramFailure              = errors.New("_cl: Compile Program Failure")
	ErrLinkerNotAvailable                 = errors.New("_cl: Linker Not Available")
	ErrLinkProgramFailure                 = errors.New("_cl: Link Program Failure")
	ErrDevicePartitionFailed              = errors.New("_cl: Device Partition Failed")
	ErrKernelArgInfoNotAvailable          = errors.New("_cl: Kernel Arg Info Not Available")
	ErrInvalidValue                       = errors.New("_cl: Invalid Value")
	ErrInvalidDeviceType                  = errors.New("_cl: Invalid Device Type")
	ErrInvalidPlatform                    = errors.New("_cl: Invalid Platform")
	ErrInvalidDevice                      = errors.New("_cl: Invalid Device")
	ErrInvalidContext                     = errors.New("_cl: Invalid Context")
	ErrInvalidQueueProperties             = errors.New("_cl: Invalid Queue Properties")
	ErrInvalidCommandQueue                = errors.New("_cl: Invalid Command Queue")
	ErrInvalidHostPtr                     = errors.New("_cl: Invalid Host Ptr")
	ErrInvalidMemObject                   = errors.New("_cl: Invalid Mem Object")
	ErrInvalidImageFormatDescriptor       = errors.New("_cl: Invalid Image Format Descriptor")
	ErrInvalidImageSize                   = errors.New("_cl: Invalid Image Size")
	ErrInvalidSampler                     = errors.New("_cl: Invalid Sampler")
	ErrInvalidBinary                      = errors.New("_cl: Invalid Binary")
	ErrInvalidBuildOptions                = errors.New("_cl: Invalid Build Options")
	ErrInvalidProgram                     = errors.New("_cl: Invalid Program")
	ErrInvalidProgramExecutable           = errors.New("_cl: Invalid Program Executable")
	ErrInvalidKernelName                  = errors.New("_cl: Invalid Kernel Name")
	ErrInvalidKernelDefinition            = errors.New("_cl: Invalid Kernel Definition")
	ErrInvalidKernel                      = errors.New("_cl: Invalid Kernel")
	ErrInvalidArgIndex                    = errors.New("_cl: Invalid Arg KeyIndex")
	ErrInvalidArgValue                    = errors.New("_cl: Invalid Arg Value")
	ErrInvalidArgSize                     = errors.New("_cl: Invalid Arg Size")
	ErrInvalidKernelArgs                  = errors.New("_cl: Invalid Kernel Args")
	ErrInvalidWorkDimension               = errors.New("_cl: Invalid Work Dimension")
	ErrInvalidWorkGroupSize               = errors.New("_cl: Invalid Work Group Size")
	ErrInvalidWorkItemSize                = errors.New("_cl: Invalid Work Item Size")
	ErrInvalidGlobalOffset                = errors.New("_cl: Invalid Global Offset")
	ErrInvalidEventWaitList               = errors.New("_cl: Invalid Event Wait List")
	ErrInvalidEvent                       = errors.New("_cl: Invalid Event")
	ErrInvalidOperation                   = errors.New("_cl: Invalid Operation")
	ErrInvalidGlObject                    = errors.New("_cl: Invalid Gl Object")
	ErrInvalidBufferSize                  = errors.New("_cl: Invalid Buffer Size")
	ErrInvalidMipLevel                    = errors.New("_cl: Invalid Mip Level")
	ErrInvalidGlobalWorkSize              = errors.New("_cl: Invalid Global Work Size")
	ErrInvalidProperty                    = errors.New("_cl: Invalid Property")
	ErrInvalidImageDescriptor             = errors.New("_cl: Invalid Image Descriptor")
	ErrInvalidCompilerOptions             = errors.New("_cl: Invalid Compiler Options")
	ErrInvalidLinkerOptions               = errors.New("_cl: Invalid Linker Options")
	ErrInvalidDevicePartitionCount        = errors.New("_cl: Invalid Device Partition Count")
)
